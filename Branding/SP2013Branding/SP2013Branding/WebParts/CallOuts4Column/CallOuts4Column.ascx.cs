...
namespace SP2013Branding.WebParts.CallOuts4Column
{
    [ToolboxItemAttribute(false)]
    public partial class CallOuts4Column : WebPart
    {
        ...
        {
            List<CallOut> callOuts = Controller.CallOutController.GetCallOut4Column();

            container.InnerHtml = BuildCallOutStyleHTML() + BuildCallOut4ColumnsHTML(callOuts);
        }

        private string BuildCallOut4ColumnsHTML(List<CallOut> callOuts)
        {
